...
const FooterData = [
    {
        ...
        links: [
            { linkTitle: "Գլխավոր", link: "/" },
            { linkTitle: "Մեր մասին", link: "/about" },
            { linkTitle: "Կապ", link: "/contact" },
    ...
    },
    {
        title: "ԲԱԺԻՆՆԵՐ",
        links: [
            { linkTitle: "Պայուսակներ", link: "/bags" },
            { linkTitle: "Աքսեսուարներ", link: "/accessories" },
            { linkTitle: "Կանացի", link: "/women-shoes" },
            { linkTitle: "Տղամարդու", link: "/men-shoes" },
                                ...
                                <div id="mc_embed_signup" className="subscribe-form">
                                    <form onSubmit={(e)=> {e.preventDefault(); Swal.fire('Success', 'Thank you for your Subscribtion', 'success');document.querySelector("input[type='email']").value = ""}}>
                                        <div className="mc-form">
                                            <input className="form-control" type="email" placeholder="Էլ․ հասցե" name="EMAIL" defaultValue="" required />
                                            <div className="clear">
                                                <button className="theme-btn-one btn_md" type="submit" name="subscribe" defaultValue="">Բաժանորդագրվել</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="copyright_left">
                                <h6>© CopyRight {new Date().getFullYear()} - Բոլոր իրավունքները պաշտպանված են:</h6>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
