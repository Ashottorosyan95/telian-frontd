                                ...
                                <div className="row">
                                    <div className="col-lg-5 col-md-6 col-sm-12 col-12">
                                        <div className="products_modal_sliders">
                                            <img src={props.data.pictures[0].img} alt="img" />
                                        </div>
                                    </div>
                                    <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                                        <div className="modal_product_content_one">
                                            ...
                                            {/* <div className="reviews_rating">
                                                ...
                                                <span>{props.data.rating.count}</span>
                                            </div> */}
                                            <h4>{props.data.sale_price} Դ․ <del style={{fontWeight: 400, color: 'gray'}}>{parseInt(props.data.price)} Դ․</del> </h4>
                                          ...
                                          `  {/* <div className="variable-single-item">
                                            ...
                                            <form id="product_count_form_one">
                                                <div className="product_count_one">
                                                    ...
                                                    <a href="#!" className="theme-btn-one btn-black-overlay btn_sm" onClick={() => addToCart(props.data.id)}>Ավելացնել Զամբյուղ</a>
                                                </div>
                                            </form>
                                            {/* <div className="modal_share_icons_one">
                                                <h4>ԿԻՍՎԵԼ ԸՆԿԵՐՆԵՐԻ ՀԵՏ</h4>
