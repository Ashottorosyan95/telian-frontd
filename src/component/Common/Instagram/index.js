      ...
      {props.container ? (
                  ...
                  <Slider {...settings}>
                    {InstgramData.map((data, index) => (
                      <div className="instgram_post" key={index}>
                        <a href="https://instagram.com/teliani_collection?utm_medium=copy_link" target="_blank">
        ...
        <section id="instagram_area_one">
          <div className="container-fluid">
            <HeadingTwo heading="Հետեվեք մեզ INSTAGRAM-ում" para="Հետևեք մեզ և տեղեկացեք մեր նորություննեին" />
            <div className="row">
              <div className="col-lg-12">
                <div className="instagram_post_slider">
                  <Slider {...settings}>
